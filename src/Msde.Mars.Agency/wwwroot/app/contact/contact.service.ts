...
export class ContactService {
    ...
    public _saveUrl: string = 'http://localhost:56853/api/Contact/PostContact/';
    public _updateUrl: string = 'http://localhost:56853/api/Contact/PutContact/';
    public _getUrl: string = 'http://localhost:56853/api/Contact/GetContact/';
    public _getByIdUrl: string = 'http://localhost:56853/api/Contact/GetContactByID/';
    public _deleteByIdUrl: string = 'http://localhost:56853/api/Contact/DeleteContactByID/';
