System.register(["angular2/core", "angular2/http", "rxjs/Rx", "rxjs/Observable"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Observable_1, ContactService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ContactService = (function () {
                function ContactService(_http) {
                    this._http = _http;
                    this._saveUrl = 'http://localhost:56853/api/Contact/PostContact/';
                    this._updateUrl = 'http://localhost:56853/api/Contact/PutContact/';
                    this._getUrl = 'http://localhost:56853/api/Contact/GetContact/';
                    this._getByIdUrl = 'http://localhost:56853/api/Contact/GetContactByID/';
                    this._deleteByIdUrl = 'http://localhost:56853/api/Contact/DeleteContactByID/';
                }
                //Get
