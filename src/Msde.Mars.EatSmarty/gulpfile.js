...
gulp.task('restore:angular-image', function () {
    gulp.src([
        'node_modules/angular2-image-popup/directives/angular2-image-popup/*.js'
    ]).pipe(gulp.dest(libs + 'angular2-image-popup'));
});
...
gulp.task('restore:angular-onsenui', function () {
    gulp.src([
        'node_modules/angular2-unsenui/dist/src/angular2-onsenui.js'
    ]).pipe(gulp.dest(libs + 'angular2-onsenui'))
})
