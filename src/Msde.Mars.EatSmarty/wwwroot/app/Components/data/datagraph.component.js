...
var DataGraph = (function () {
    //Constructor
    function DataGraph(pageService, config, route, router) {
    ...
    DataGraph.prototype.ngAfterViewInit = function () {
        this.resmessage = "";
        this.editId = 0;
        $(this.mainwrapper.nativeElement).css("background-color", "#ffffff");
        $(this.mainwrapper.nativeElement).show();
    };
    DataGraph.prototype.ngOnInit = function () {
        this.setData(true);
    };
    DataGraph.prototype.setData = function (t) {
        var _this = this;
        this.pageService
            .getById(this.editId)
            .then(function (text) { return _this.maintext = _this.SetDefaults(text); });
    };
    DataGraph.prototype.SetDefaults = function (page) {
    ...
    DataGraph.prototype.showEdit = function (e, t) {
        t.isEditHidden = false;
    };
    DataGraph.prototype.showDelete = function (e, t) {
        e.preventDefault();
...
], DataGraph.prototype, "mainwrapper", void 0);
DataGraph = __decorate([
    core_1.Component({
        selector: 'datagraph-list',
        templateUrl: 'app/templates/graph.view.html',
...
//# sourceMappingURL=datagraph.component.js.map